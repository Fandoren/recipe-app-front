...
export default function NavBarLinkList() {
  return (
    ...
    >
      <NavBarLink name="Рецепты" path="/" />
      <NavBarLink name="Продукты" path="/products"/>
      <NavBarLink name="Разделы" path="/categories"/>
      <NavBarLink name="Калькулятор питания" path="/calculator"/>
    </ul>
  );
}
